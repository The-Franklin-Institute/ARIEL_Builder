...
class Arduino:
    ...
    def __init__(self, port, baudrate=115200):
        ...
        self.serial = serial.Serial(port, baudrate, bytesize=8, timeout=0)
        ...
        self.digital_output_data =  [ 0] * 50
        self.digital_input_data  = [ 0] * 50
        self.analog_input_data = [ 0 ] * 50
        ...
        if self.parsing_sysex:
            ...
            if self.exec_multibyte_cmd != 0 and self.wait_for_data == 0:
                if self.exec_multibyte_cmd ==  DIGITAL_MESSAGE:
                    ...
                    #print "analog read",self.stored_input_data[0],self.stored_input_data[1],(self.stored_input_data[0] << 7) + self.stored_input_data[1]
