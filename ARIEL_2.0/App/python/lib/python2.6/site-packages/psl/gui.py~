...
def getFilenameToOpen():
    import popen2
    out,junk = popen2.popen2("/Applications/CocoaDialog.app/Contents/MacOS/CocoaDialog fileselect")
    return out.readline()[:-1]

def doPopupMessage(msg,alt=""):
    import popen2
    if alt == "":
        out,junk = popen2.popen2('/Applications/CocoaDialog.app/Contents/MacOS/CocoaDialog ok-msgbox --no-cancel --float --text "'+msg+'"')
    else:
        out,junk = popen2.popen2('/Applications/CocoaDialog.app/Contents/MacOS/CocoaDialog ok-msgbox --no-cancel --float --text "'+msg+'" --informative-text "'+alt+'"')
    return out.readline()[:-1]

def getFilenameToSave():
    import popen2
    out,junk = popen2.popen2("/Applications/CocoaDialog.app/Contents/MacOS/CocoaDialog filesave")
    return out.readline()[:-1]
